...
$pasien = ['nama'=> $bmi->nama, 'kelamin'=> $bmi->jenisKelamin, 'umur'=>$bmi->umur, 'berat'=>$bmi->berat,'tinggi'=>$bmi->tinggi];


if ( ! isset($_SESSION['data']) ){
    $_SESSION['data'] = [];
}
array_push($_SESSION['data'], $pasien);
    ...
    <div class="container">
        ...
        <table class="table table-hover table-striped">
            ...
            <tbody>
                <?php 
                    $nomor = 1;
                    foreach($_SESSION['data'] as $pasien) {
                        echo '<tr><td>'.$nomor.'</td>';
